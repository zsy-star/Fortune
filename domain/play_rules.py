...
_RULES = (
    ...
    _play(
        ...
        odds_keys=("平特一肖",),
        rebate_keys=("平特一肖", "统一返水", "默认返水"),
        notes="V2全部7码 matcher 尚未实施。",
    ),
    _play(
        "平特一肖带主肖",
        "pingte_main_zodiac",
        ...
        availability=SettlementAvailability.BLOCKED_PENDING_RULE_FIX,
        odds_keys=("平特一肖主肖",),
        rebate_keys=("平特一肖主肖", "统一返水", "默认返水"),
        notes="主肖只改变赔率键；V2 matcher 尚未实施。",
    ),
    _play(
        "平尾",
        "ping_tail",
        ...
        matcher_id="match_ping_tail",
        notes="当前 matcher 范围和多尾派彩尚未达到V2规则。",
    ),
    _play(
        "连肖",
        ...
        matcher_id="match_zodiac_group",
        notes="当前 matcher 仅检查特别号，V2规则尚未实施。",
    ),
    _play(
        "连肖复选",
    ...
    _play(
        ...
        matcher_id="match_non_hit_number",
        notes="当前 matcher 仍检查特别号，V2规则尚未实施。",
    ),
    _play(
        "三中二",
        "lianma_three_two",
